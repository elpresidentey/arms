      ...
      <Surface title="Route board" subtitle="Residents can confirm their next collection window while operations staff can close serviced routes.">
        {isError ? (
          ...
          <div className="space-y-4">
            {routes.map((route) => (
              <article key={route.id} className="rounded-3xl border border-slate-200/80 bg-white p-4 shadow-[0_1px_2px_rgba(15,23,42,0.04),0_12px_32px_-20px_rgba(15,23,42,0.14)] transition-all duration-200 hover:border-primary-200/70 hover:shadow-[0_16px_40px_-22px_rgba(15,23,42,0.2)]">
